...
\begin{itemize}
  ...
  \item Figure~1 Panel~C now includes the same seven methods and AUROC values as
  Table~1 under the random, Target-ID-held-out, and Drug-ID-held-out protocols.
...
Figure~1 Panel~C has also been regenerated to include the same seven methods and
AUROC values reported in Table~1 for all three identifier-based protocols.

\change{Related Work; Results, ``Comparison with Baseline Methods'';
Discussion, ``Future Directions''; Figure~1.}
