...
\url{https://doi.org/10.5281/zenodo.21431147}. The archive contains the released
...
\response Following the final reproducibility audit, we withdrew the numerical
ablation figure, table, and component-effect claims because matching
ablated-model checkpoints and predictions are unavailable. Rather than redraw an
irreproducible comparison, we removed it and state this limitation explicitly.
...
confirm absence of overfitting. Following final log audit, Figure~4 was rebuilt
...
\change{Results, ``Training Dynamics'' and Figure~4 caption.}
...
be conflated. Figure~6 is described as the
...
\change{Data Availability; Figure~6 caption; Conclusion.}
...
``The 99.2\% Attention Sparsity''; Figure~5 and functional-group tables.}
...
ablation figure, table, and component-effect claims because matching
ablated-model checkpoints and predictions are unavailable. Rather than redraw an
irreproducible comparison, we removed it. The revised manuscript now
states this limitation explicitly and confines conclusions to reconstructible
...
\response Figure~4 now identifies Panel~A as validation AUROC and Panel~B as
...
\change{Revised Figure~4 and caption.}
...
\response We rebuilt Figure~5 from the archived 1,301,380 pair-normalised
...
physical-contact or hotspot labels. Revised Fig.~6 now presents Panel A as the
...
\url{https://doi.org/10.5281/zenodo.21431147}, which preserves the release
