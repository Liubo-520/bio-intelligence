...
\flushbottom
\maketitle
\noindent\textcolor{red}{\textit{Marked revision: substantive additions and revised interpretations are shown in red. Withdrawn analyses and deleted material are identified in the point-by-point response.}}\par\medskip
...
\caption{\textbf{Baseline comparison.} Panels A and B show random-split AUROC
  and AUPRC, respectively, for all seven methods. Panel C shows AUROC for the
  same seven methods under the random, Target-ID-held-out, and Drug-ID-held-out
  protocols. BioInteract
...
\caption{\textbf{BioInteract performance and split audit.} Panel A displays
  ...
  \begingroup\color{red}exact-sequence-grouped\endgroup{} cold-both evaluations.}
\label{fig:performance}
\end{figure}

\FloatBarrier

\begingroup\color{red}The maximum normalised Indel similarity between each test
