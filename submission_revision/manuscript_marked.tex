...
have faithfulness limitations.\cite{jain2019attention} \begingroup\color{red}A central principle is
...
output but still require external validation before mechanistic interpretation.\endgroup
...
\begingroup\color{red}We contextualise BioInteract against six published DTI
baselines spanning sequence, graph, attention, transformer, and bilinear
interaction models: DeepDTA,\cite{ozturk2018deepdta}
...
and DrugBAN.\cite{bai2023drugban} Table~\ref{tab:baseline_questions} summarises
representational contrasts without assigning causal credit to any component. We
do not retain cross-model numerical comparisons because matched code, splits,
predictions, and evaluation artefacts for the historical baselines are
unavailable. Accordingly, all quantitative results in this revision are
traceable BioInteract evaluations or explicit diagnostic controls.\endgroup
...
\caption{Strict within-Davis cold-start evaluation after grouping target
  ...
  architecture, but are separately trained from initialisation. \begingroup\color{red}For cold-both, 70/10/20 is applied
...
\begin{figure}[htbp]
  ...
  \caption{\textbf{BioInteract interactive web server.}
    ...
    The \begingroup\color{red}enlarged\endgroup{} lower portion displays the generated atom--residue attention
...
\url{https://doi.org/10.5281/zenodo.21436919}. The BioInteract source repository
...
as the immutable Zenodo release, \url{https://doi.org/10.5281/zenodo.21436919}.
The interactive web
