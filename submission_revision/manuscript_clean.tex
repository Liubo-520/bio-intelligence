...
We contextualise BioInteract against six published DTI baselines spanning
...
Table~\ref{tab:baseline_questions} summarises representational contrasts without
assigning causal credit to any component. We do not retain cross-model numerical
comparisons because matched code, splits, predictions, and evaluation artefacts
for the historical baselines are unavailable. Accordingly, all quantitative
results in this revision are traceable BioInteract evaluations or explicit
diagnostic controls.
